...
.global	find
	.align	4
find:	save	%sp, -96, %sp
										! the beginning of the find fuction(subroutine)
...
ret
	...
	.type	find, #function
	.size	find, . - find
										! the end of the find function(subroutine)
...
.global	term
	.align	4
term:	save	%sp, -96, %sp
										! the beginning of the term fuction(subroutine)
...
ret
	...
	.type	term, #function
	.size	term, . - term
										! the end of the term function(subroutine)

.global	factor
	.align	4
factor:	save	%sp, -96, %sp
									! the beginning of the factor fuction(subroutine)
...
ret
	...
	.size	factor, . - factor
										! the end of the factor function(subroutine)
	
done:
		mov	1, %g1
	ta	 0										! exit of the program
